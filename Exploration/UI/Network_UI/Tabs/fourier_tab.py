...
class fourier_tab():
    ...
    def initialize(self, Network_UI):
        self.fourier_tab = Network_UI.Next_Tab('fourier')

        curves, exc_plt = Network_UI.Add_plot_curve('Excitatory', colors=[(0, 0, 0)], legend=False, number_of_curves=6, return_plot=True, x_label='Frequency [Hz]', y_label='Amplitude')
