...
from Exploration.UI.SORN_UI.Tabs.SORN_UI_Sidebar_Image_Module import *
from Exploration.UI.SORN_UI.Tabs.SORN_UI_Sidebar_Grammar_Module import *
from Exploration.UI.SORN_UI.Tabs.SORN_UI_Sidebar_Fast_Forward import *
from Exploration.UI.SORN_UI.Tabs.SORN_UI_Sidebar_Save_Load import *
from Exploration.UI.SORN_UI.Tabs.SORN_activity_tab import *
from Exploration.UI.SORN_UI.Tabs.SORN_buffer_tab import *
from Exploration.UI.SORN_UI.Tabs.SORN_hist_tab import *
from Exploration.UI.SORN_UI.Tabs.SORN_info_tabs import *
from Exploration.UI.SORN_UI.Tabs.SORN_inh_exc_tab import *
from Exploration.UI.SORN_UI.Tabs.SORN_scatter_tab import *
from Exploration.UI.SORN_UI.Tabs.SORN_stability_tab import *
from Exploration.UI.SORN_UI.Tabs.SORN_weight_tab import *
from Exploration.UI.SORN_UI.Tabs.SORN_reconstruction_tab import *
from Exploration.UI.SORN_UI.Tabs.SORN_fourier_tab import *
from Exploration.UI.SORN_UI.Tabs.SORN_partition_tab import *
from Exploration.UI.SORN_UI.Tabs.SORN_UI_Sidebar_MusicModule import *
from Exploration.UI.SORN_UI.Tabs.spiketrain_tab import *

default_modules = [
    SORN_UI_sidebar_activity(1),
    SORN_activity_tab(['output', 'TH', 'weight_norm_factor', 'nox', 'refractory_counter']),
    spiketrain_tab(),
    SORN_weight_tab(),
    SORN_partition_tab(),
    SORN_UI_sidebar_image_module(),
    SORN_UI_sidebar_grammar_module(),
    #SORN_UI_sidebar_music_module(),
    SORN_buffer_tab(),
    SORN_reconstruction_tab(),
    SORN_hist_tab(),
    SORN_inh_exc_tab(),
    SORN_stability_tab(),
    SORN_scatter_tab(),
    SORN_fourier_tab(),
    SORN_info_tab(),
    SORN_UI_sidebar_fast_forward(),
    SORN_UI_sidebar_save_load()
]

class SORN_UI(UI_Base):
