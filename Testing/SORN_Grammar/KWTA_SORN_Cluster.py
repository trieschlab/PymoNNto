...
def run(attrs={'name': 'KWTA', 'ind': [], 'N_e': 900, 'plastic': 15000, 'refrac':0.1}):
    ...
    e_ng = NeuronGroup(net=SORN, tag='PC_{},prediction_source'.format(1), size=get_squared_dim(attrs['N_e']), behaviour={
                ...
                3: SORN_init_afferent_synapses(transmitter='GLU', density='99%', distribution='uniform(0.1,1.0)', normalize=True),#20%#lognormal(0,[0.95#1]) #[13#0]% #, partition_compensation=True , partition_compensation=True #lognormal(0,0.95)
                #4: SORN_init_afferent_synapses(transmitter='GABA', density='[30#1]%', distribution='uniform(0.0,1.0)', normalize=True),
                5: SORN_init_afferent_synapses(transmitter='GLU_cluster', density='99%', distribution='uniform(0.1,1.0)', normalize=True),
                ...
                21.2: SORN_STDP(transmitter='GLU_cluster', eta_stdp='[0.00025#5]', STDP_F={0: 0.5}),  #[0.00015#7]
