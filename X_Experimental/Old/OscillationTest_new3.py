...
def run(ind=[], thread_index=None):
    ...
    e_ng = NeuronGroup(tag='main_exc_group', size=get_squared_dim(N_e),
                       behaviour={
                           ...
                           4: SORN_init_afferent_synapses(transmitter='GABA', density=90, distribution='lognormal(0,[0.8#9])', normalize=True),

                           12: SORN_slow_syn(transmitter='GLU', strength='[0.146#0]', input_strength=1.0),
                           13: SORN_slow_syn(transmitter='GABA', strength='-[0.17#1]'),
                           ##16: SORN_intra_Gamma(transmitter='GLU', strength=1),
                           17: SORN_fast_syn(transmitter='GABA', strength='-[0.112#2]'),
                           20: SORN_input_collect(),

                           21: SORN_STDP(eta_stdp='[0.04#13]', prune_stdp=False),
                           22: SORN_SN(syn_type='GLU', clip_max=None),#l_norm_mean(0.05, [0.3#6])
                           23: SORN_IP_TI(h_ip='l_norm_mean([0.05#12], [0.3#6])', eta_ip='0.00046;+-45.4%', integration_length=9, gap_percent=10, clip_min=-0.001),  # TODO:0.04 0.005  #'0.06;+-[33#6]%'  [0.4#6] , clip_min=-0.001
    ...
    i_ng = NeuronGroup(tag='main_inh_group', size=get_squared_dim(int(0.2 * N_e)), behaviour={
        ...
        3: SORN_init_afferent_synapses(transmitter='GLU', density=450, distribution='lognormal(0,[0.8#10])', normalize=True),
        ...
        11: SORN_slow_syn(transmitter='GABA', strength='-[0.154#3]'),
        14: SORN_fast_syn(transmitter='GLU', strength='[1.415#4]'),
        15: SORN_fast_syn(transmitter='GABA', strength='-[0.08118#5]'),
        20: SORN_input_collect(),
...
#Server: 10k full 8514?
#poppy: 5k full 8523?
#xps: 10k 0.05    5961



ind = [0.146, 0.17, 0.112, 0.154, 1.415, 0.08118, 0.3, 0.001, 0.8, 0.8, 0.8, 0.8, 0.05, 0.04]
ind2 = [0.559, 0.038, 0.121, 0.001, 1.35, 0.0013366, 0.293, 0.00103, 0.81, 0.46, 0.68, 0.673, 0.05, 0.04]
ind3 = [0.14201997510477282, 0.16494898803860414, 0.11192572298848574, 0.15864855160992106, 1.4053041702456583, 0.08084498360799097, 0.28970166065385844, 0.0010239410039734568, 0.7844483266479545, 0.7935997693139245, 0.832195609007983, 0.8050000681044611, 0.05, 0.04]
ind4=[0.14839807132793192, 0.16923333513351657, 0.11549157964141717, 0.1592899878225497, 1.4290213344357492, 0.07939229779881884, 0.29142448856369685, 0.0009988834188948532, 0.8252899109402059, 0.8025652742969079, 0.8346114645206202, 0.8170996234622687, 0.05, 0.04]
...
if __name__ == '__main__':
    if True:
        ...
        evolution.start([ind, ind2, ind3, ind4])
